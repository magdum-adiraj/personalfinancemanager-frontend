...
const Menubar = ({activeMenu}) => {
    ...
    return (
        <div className="flex items-center justify-between gap-5 bg-white border border-b border-gray-200/50 backdrop-blur-[2px] py-4 px-4 sm:px-7 stick top-0 z-30">
            ...
            <div className="flex items-center gap-5">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-lg font-medium text-black truncate">Personal Finance Manager</span>
                </div>
            </div>
