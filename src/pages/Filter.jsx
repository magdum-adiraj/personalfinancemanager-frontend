            ...
            <div className="my-5 mx-auto">
                ...
                <div className="bg-white rounded-lg shadow p-4 mb-4">
                    ...
                    <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1" htmlFor="sortfield">Sort Field</label>
                        ...
                        <div className="sm:col-span-1 md:col-span-1 flex items-end">
                            ...
                            <button onClick={handleSearch} className="ml-2 mb-1 p-2 bg-purple-300 hover:bg-purple-700 hover:text-white rounded flex items-center justify-center cursor-pointer">
                                <Search size={20}/>
                            </button>
                        </div>
                    </form>
                ...
                <div className="bg-white rounded-lg shadow p-4">
                    ...
                    {transactions.length === 0 && !loading ? (
                        <p className="text-gray-500">Select filters and click apply to filter transactions</p>
                    ) :""}
                    {loading ?(
